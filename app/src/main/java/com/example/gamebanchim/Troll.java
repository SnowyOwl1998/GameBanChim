...
public class Troll {
    ...
    int x = 0,y, width, height, birdCounter = 1, deadCounter = 1;
    Bitmap bird1, bird2, bird3, bird4, dead1, dead2, dead3, dead4;

    Troll(Resources res) {
        bird1 = BitmapFactory.decodeResource(res, R.drawable.bird3_1);
        bird2 = BitmapFactory.decodeResource(res, R.drawable.bird3_2);
        bird3 = BitmapFactory.decodeResource(res, R.drawable.bird3_3);
        bird4 = BitmapFactory.decodeResource(res, R.drawable.bird3_4);
